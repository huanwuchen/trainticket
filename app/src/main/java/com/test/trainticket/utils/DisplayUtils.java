...
public class DisplayUtils {
    ...
    public static int px2dip(float pxValue) {
        final float scale = TrainTicketApplication.getInstance().getResources().getDisplayMetrics().density;
    ...
    public static int px2sp(float pxValue) {
        final float fontScale = TrainTicketApplication.getInstance().getResources().getDisplayMetrics().scaledDensity;
